...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (self.displayType == kDisplayProvince) {
        ...
        //构建下一级视图控制器
        AreaSelectorViewController *cityVC = [[AreaSelectorViewController alloc]init];
        ...
        //构建下一级视图控制器
        AreaSelectorViewController *areaVC = [[AreaSelectorViewController alloc]init];
...
-(void)submit{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"address" object:msg];
